...
export const LOG_TYPES = {
  ...
  gcs: { api: 'gcs' },
  pubsub: { api: 'pubsub' },
  grafanacloudlogs: { api: 'grafanacloudlogs' },
  https: { api: 'https' },
  heroku: { api: 'heroku' },
  honeycomb: { api: 'honeycomb' },
  kafka: { api: 'kafka' },
  kinesis: { api: 'kinesis' },
  logshuttle: { api: 'logshuttle' },
  loggly: { api: 'loggly' },
  azureblob: { api: 'azureblob' },
  newrelics: { api: 'newrelic' },
  newrelicotlp: { api: 'newrelicotlp' },
  openstack: { api: 'openstack' },
  papertrail: { api: 'papertrail' },
  s3: { api: 's3' },
  sftp: { api: 'sftp' },
  scalyr: { api: 'scalyr' },
  splunks: { api: 'splunk' },
  sumologic: { api: 'sumologic' },
  syslog: { api: 'syslog' },
};
